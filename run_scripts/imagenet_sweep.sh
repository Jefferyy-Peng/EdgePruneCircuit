EDGE_SPARSITIES=(0.94 0.96 0.98 1.05)
...
accelerate launch src/prune/vit_imagenet.py \
    --report_to wandb \
    --do_train \
    --do_eval \
    ...
    --output_dir ./data/runs/${ABLATE_MODE}_ablate-imagenet-${TAG}-elr${ELR}-llr${LLR}-relr${RELR}-rllr${RLLR}-es${EDGE_SPARSITY}-ns${NODE_SPARSITY}-t${TOTAL}/ \
